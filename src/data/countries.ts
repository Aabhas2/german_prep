...
export const countriesConfig: Record<string, CountryConfig> = {
  Germany: {
    ...
    stages: [
      ...
      { phase: 'Phase 4', title: 'Open Blocked Account (Sperrkonto)', description: 'Deposit €11,904 (2026 requirement) in a German blocked account via Fintiba, Expatrio, or Coracle. You receive €992/month once activated in Germany. Obtain the confirmation letter for your visa.' },
